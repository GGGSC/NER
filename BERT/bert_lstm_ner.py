...
if os.name == 'nt':
    bert_path = 'D:\Administrator\Downloads\chinese_L-12_H-768_A-12 (1)\chinese_L-12_H-768_A-12'
    root_path = r'D:\Administrator\Downloads\Name-Entity-Recognition-master\BERT-BiLSTM-CRF-NER'
else:
